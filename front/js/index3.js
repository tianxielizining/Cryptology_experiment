...
var in_first = document.getElementById("in_first");
var in_second = document.getElementById("in_second");
var in_third = document.getElementById("in_third");
var field = {}
var hasFocus = false;
...
function reposition() {
	...
	field = in_first.getBoundingClientRect();//??????为什么只有first没有second？？？
}
...
in_first.onfocus = function () { field = in_first.getBoundingClientRect(); hasFocus = true; }
in_second.onfocus = function () { field = in_second.getBoundingClientRect(); hasFocus = false; }
in_third.onfocus = function () { field = in_third.getBoundingClientRect(); hasFocus = false; }
...
function burst(intensity) {
	...
	var input = hasFocus ? in_first : in_second;
	var input = hasFocus ? in_second : in_third;
	var input = hasFocus ? in_first : in_third;
	// left edge
